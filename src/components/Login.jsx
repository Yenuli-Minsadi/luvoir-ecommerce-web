  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-white bg-opacity-50">
      <div onSubmit={onSubmitHandler} className="bg-gray-950 rounded-lg shadow-xl p-8 w-full max-w-md mx-4">
        ...
        <div className="flex items-center w-full mt-4 bg-white border-gray-700 h-12 rounded-full overflow-hidden pl-6 gap-2 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"
            height="14"
        ...
        <div className=" flex items-center mt-4 w-full bg-white border-gray-700 h-12 rounded-full overflow-hidden pl-6 gap-2 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="14"
            height="14"
        ...
        <div className="mt-4 text-right mb-5">
          <button className="text-sm text-cyan-200 hover:underline">
            Forget password?
          </button>
        </div>
        ...
        <button
          type="submit"
          className="mt-2 w-full h-11 rounded-full text-gray-950 font-semibold cursor-pointer  bg-cyan-200 hover:bg-rose-800 hover:text-amber-50 transition "
        >
          {state === "login" ? "Login" : "Sign up"}
        </button>
        ...
        <p
          ...
          className="text-gray-400 text-sm mt-3 mb-11 cursor-pointer text-center"
        >
          {state === "login"

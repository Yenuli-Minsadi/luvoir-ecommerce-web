...
const NewsLetter = () => {
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center mt-30 mb-30">
        <div className="flex items-center gap-2 text-sm text-rose-800 bg-indigo-50 rounded-full px-3 py-1">
          <svg
            width="13"
            height="14"
            viewBox="0 0 13 14"
        ...
        <h1 className="text-4xl md:text-4xl font-semibold text-gray-900 mt-4">
          Get Updated on Hot Deals
        </h1>
        <p className="max-w-lg text-center text-slate-500 mt-6">
          Subscribe to get weekly seasonal updates on our hottest deals.
        </p>
        <form className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full h-10">
          <svg
          ...
          <input
            ...
            required
          />
          <button className="shrink-0 px-6 h-10 flex items-center text-sm bg-gradient-to-r from-rose-950 to-rose-900 rounded-md active:scale-95 transition duration-300 text-white">
            Subscribe now
          </button>
        </form>
      </section>
